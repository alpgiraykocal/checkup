...
const EXTRA = {
  ...
  sets: [
    ...
    /* ---------- 1. Terör finansmanı ve kâr amacı gütmeyen kuruluşlar ---------- */
    {
      ...
      questions: [
        { id: 'EK-TF-01', crit: 'Kritik', weight: 5, qa: true, domain: 'D11',
        ...
        { id: 'EK-TF-02', crit: 'Kritik', weight: 5, qa: true, domain: 'D2',
        ...
        { id: 'EK-TF-03', crit: 'Yüksek', weight: 4, qa: true, domain: 'D5',
          ...
          source: 'FATF R.8 IN' },
        { id: 'EK-TF-04', crit: 'Kritik', weight: 5, qa: true, domain: 'D7',
    ...
    /* ---------- 2. İç hat: personel ve dahili bildirim ---------- */
    {
      ...
      questions: [
        { id: 'EK-IC-01', crit: 'Kritik', weight: 5, qa: true, domain: 'D1',
    ...
    /* ---------- 3. Yaptırım lookback ve model yönetişimi ---------- */
    {
      ...
      questions: [
        ...
        { id: 'EK-MD-05', crit: 'Kritik', weight: 5, qa: true, domain: 'D7',
        ...
        { id: 'EK-MD-07', crit: 'Orta', weight: 3, domain: 'D7',
          ...
          source: 'Model risk yönetimi standardı' },
        { id: 'EK-MD-08', crit: 'Kritik', weight: 5, domain: 'D7',
    ...
    /* ---------- 4. Sigorta ve emeklilik ---------- */
    {
      ...
      questions: [
        { id: 'EK-SG-01', crit: 'Kritik', weight: 5, qa: true, domain: 'D5',
    ...
    /* ---------- 5. Elektronik para ve ödeme ---------- */
    {
      ...
      questions: [
        { id: 'EK-EP-01', crit: 'Kritik', weight: 5, qa: true, domain: 'D1',
    ...
    /* ---------- 8. Aracı kurum ve portföy yönetimi ---------- */
    {
      ...
      questions: [
        { id: 'EK-AK-01', crit: 'Kritik', weight: 5, qa: true, domain: 'D4',
